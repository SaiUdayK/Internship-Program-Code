...
class win:#Class
    ...
    def event(e):
        ...
        try:
            ...
            dispaly_label = Label(root,text="Number cannot be a string", font=("Candara",18), bg="#c6cdaf")
            dispaly_label.place(x=250,y=400)
        count=0
        x1=1
        y1=350
        ...
        if int(var1.get())==rand2:
            ...
            display_label=Label(root,text="Pls input valid number",font=("Candara",20), bg="#FABF2D")
            display_label.place(x=x1,y=y1)
    ...
    def restart():
        ...
        os.startfile("H:\\Internship-2022\\Guess the number.pyw")#Starting the program using the path we saved.
...
#Image
image2=Image.open("H:\\Internship-2022\\guess the number.png")
