...
class game: #Class:- Contains all the def functions
    ...
    def rockpaperscissors(): #Rockpaperscissors
        os.startfile("H:\\Internship-2022\\rock_paper_scissors.pyw")#Opening rock paper scissors.
    def guessthenumber():
        os.startfile("H:\\Internship-2022\\Guess the number.pyw")#Opening guess the number.
...
main_img=ImageTk.PhotoImage(Image.open("H:\\Internship-2022\\Arcade.jpg"))#Opening the image
